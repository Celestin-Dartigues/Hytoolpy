"""
Agawarl (1970) model the aquifer for a constant rate pumping test in a 
...
def rpt(p, stats, t, s, d,
        ...
        color=None):
    """
    Generate final report for Agawarl model with fitted model results.
